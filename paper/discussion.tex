...
histograms, triggering wholesale decompression of cold pages.  These
two behaviors reduce \sys's effectiveness from 94\% RSS reduction
(with patches) to 68\% (without).
