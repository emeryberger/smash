...
SYNTH_DATA = {
    ...
    'sqlite_macos': {'title': 'SQLite (macOS)',
                  'baseline': (614, 424, 613),
                  'mesh':     (618, 438, 618),
                  'smash':    (452, 111, 178)},
    'rocksdb_macos': {'title': 'RocksDB (macOS)',
                  'baseline': (416, 416, 416),
                  'mesh':     (309, 309, 309),
                  'smash':    (492, 68, 122)},
    'memcached_macos': {'title': 'Memcached (macOS)',
                  'baseline': (297, 297, 297),
                  'mesh':     (298, 298, 298),
                  'smash':    (330, 79, 79)},
    'redis_macos': {'title': 'Redis (macOS)',
                  'baseline': (117, 117, 117),
                  'mesh':     (97, 97, 97),
                  'smash':    (138, 40, 40)},
    'redis_ext_macos': {'title': 'Redis-ext (macOS)',
                  'baseline': (117, 78, 78),
                  'mesh':     (117, 78, 78),
                  'smash':    (136, 46, 46)},
}
