...
D=/home/emerydb/mariadb_bench/data; S=/home/emerydb/mariadb_bench/mysql.sock; L=/home/emerydb/mariadb_bench/vw.log
...
for i in $(seq 1 12); do
  sleep 3
  vmas=$(wc -l < /proc/$MPID/maps)
  rss=$(awk '/VmRSS/{print int($2/1024)}' /proc/$MPID/status)
  echo "  t=$((i*3))s VMAs=$vmas RSS=${rss}MB"
done
